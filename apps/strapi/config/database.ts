    ...
    mysql2: {
      connection: {
        ...
        ssl: env.bool("MYSQL_SSL", false) && {
          key: env("MYSQL_SSL_KEY", undefined),
          cert: env("MYSQL_SSL_CERT", undefined),
          ca: env("MYSQL_SSL_CA", undefined),
          capath: env("MYSQL_SSL_CAPATH", undefined),
          cipher: env("MYSQL_SSL_CIPHER", undefined),
          rejectUnauthorized: env.bool(
            "DATABASE_SSL_REJECT_UNAUTHORIZED",
            true
          ),
